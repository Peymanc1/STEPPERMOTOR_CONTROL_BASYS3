...
HD_PWD='C:/Users/ASUS/Desktop/ddApp - 10 Gncel Uygulama/AdimMotorUygulama/AdimMotorUygulama.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log STEPPER_MOTOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source STEPPER_MOTOR.tcl
