...
HD_PWD='C:/Users/ASUS/Desktop/ddApp - 10 Gncel Uygulama/AdimMotorUygulama/AdimMotorUygulama.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log STEPPER_MOTOR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source STEPPER_MOTOR.tcl -notrace
